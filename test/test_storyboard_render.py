...
from osu_catch_renderer.beatmap.storyboard import Origin
from osu_catch_renderer.render.storyboard_render import (
...
def test_storyboard_gl_smoke():
    ...
    from osu_catch_renderer.beatmap.storyboard import parse_storyboard_text
