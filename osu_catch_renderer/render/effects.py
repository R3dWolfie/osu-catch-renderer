"""Effect lifecycle math for the catch renderer's intro splash.

Ported from the std renderer (osu_std_renderer/render/effects.py) so the R3D
...
pure functions. Only the LOGO section is ported (catch has no bg-triangles /
seizure card / etc.).
"""
